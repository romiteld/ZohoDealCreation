    ...
    if test_recipient_email:
        ...
        for action in card["content"].get("actions", []):
            if action.get("type") == "Action.Submit":
                action.setdefault("data", {}).setdefault("msteams", {}).setdefault("value", {})["test_recipient_email"] = test_recipient_email
            elif action.get("type") == "Action.ShowCard":
                inner_card = action.get("card", {})
                for show_action in inner_card.get("actions", []):
                    if show_action.get("type") == "Action.Submit":
                        show_action.setdefault("data", {}).setdefault("msteams", {}).setdefault("value", {})["test_recipient_email"] = test_recipient_email
