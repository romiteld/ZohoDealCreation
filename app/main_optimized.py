...
async def process_email_intake(
    ...
    blob_client = blob_client_task.result() if not isinstance(blob_client_task, Exception) else None
    zoho_client = zoho_client_task.result() if not isinstance(zoho_client_task, Exception) else None
    crew_manager = crew_manager_task.result() if not isinstance(crew_manager_task, Exception) else None
    business_rules = business_rules_task.result() if not isinstance(business_rules_task, Exception) else None
