...
CONTAINER_URL = "https://well-intake-api.wittyocean-dfae0f9b.eastus.azurecontainerapps.io"
    ...
    def test_manifest_endpoint(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                container_count = response.text.count('well-intake-api.wittyocean-dfae0f9b.eastus.azurecontainerapps.io')
